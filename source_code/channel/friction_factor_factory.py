...
from channel.friction_factor_models import (
    FrictionFactorModelType,
    FrictionFactors
)

import channel.laminar_friction as lamf
import channel.turbulent_friction as turf
import channel.total_friction as totf
...
class FrictionFactorFactory:
    ...
    def _create_total(
        ...
        transitional_models = {
            ...
            FrictionFactorModelType.DUCT_DEMO_COMMON
        }
